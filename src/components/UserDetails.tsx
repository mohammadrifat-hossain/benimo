    ...
    <div>
      {authorInfo ? (
        <div className="flex items-center justify-start gap-2">
          <Image
          src={ authorInfo?.image ? authorInfo?.image : "https://img.freepik.com/free-vector/illustration-businessman_53876-5856.jpg?t=st=1709793783~exp=1709797383~hmac=1eb331173ed3f1b60b281adfa47fc12c20d1839130ecf9b7e5fb9f961a1bc8a5&w=826"}
          alt="profile"
          height={40}
          width={40}
        ...
        />
          <div>
            <Link href={`/userprofile/42434`} className="text-lg font-bold">
              {authorInfo.name}
            </Link>
